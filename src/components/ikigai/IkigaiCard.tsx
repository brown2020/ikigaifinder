 ...
 * units so html2canvas reproduces it faithfully at any capture scale.
 */
export default function IkigaiCard({ id, statement, name, date, imageUrl, priority }: IkigaiCardProps) {
  ...
  return (
    <div
      ...
      style={{ containerType: "inline-size", backgroundColor: "#1f1a17" }}
    >
      <Image
      ...
      <div
        ...
        style={{ padding: "7cqw", color: "#faf7f2" }}
      >
        <div className="flex items-center" style={{ gap: "2cqw", fontSize: "2.6cqw", letterSpacing: "0.2em" }}>
          <span
            style={{
        ...
        <div
          ...
          style={{ fontSize: "2.4cqw", color: "rgba(250,247,242,0.8)" }}
        >
          <span>
