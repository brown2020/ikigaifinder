...
export default function HowItWorks() {
  ...
  return (
    <section
      id="how-it-works"
      className="relative py-12 bg-linear-to-b from-blue-50/60 to-background"
    >
      <Container>
        <SectionHeader
          title="How it works"
          ...
          {steps.map((step, idx) => (
            <li key={step.title} className="group">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-linear-to-br from-blue-500/15 to-indigo-500/15 flex items-center justify-center">
